...
const file_hello_proto_rawDesc = "" +
	...
	"\aGreeter\x122\n" +
	"\bSayHello\x12\x13.hello.HelloRequest\x1a\x11.hello.HelloReply\x120\n" +
	"\x06SayBye\x12\x13.hello.HelloRequest\x1a\x11.hello.HelloReplyB\tZ\a./hellob\x06proto3"
...
var file_hello_proto_depIdxs = []int32{
	...
	0, // 1: hello.Greeter.SayBye:input_type -> hello.HelloRequest
	1, // 2: hello.Greeter.SayHello:output_type -> hello.HelloReply
	1, // 3: hello.Greeter.SayBye:output_type -> hello.HelloReply
